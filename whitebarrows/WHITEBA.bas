  ...
  190IN.$Q
  200IF?Q=CH"V";GOS.5000;G.240
  210IF?Q=CH"C";GOS.4000;G.240
  220IF?Q=CH"M";GOS.3000;G.240
  230G.190
  240IF AAY=0 OR K=1 OR AAY=10 OR AAY=11 OR W=1;G.280
  250P."THE ";Z=Y;GOS.2000 
  260P."SUDDENLY ATTACKS !"'
  270G.390
  280IF M>0;G.320
  ...
  310G.390
  320IF W=0;G.170
  330P."CONGRATULATIONS YOU HAVE"'
  340P."DEFEATED THE EVIL SORCERER !"'
  350P."WOULD YOU LIKE TO TRAP ANOTHER"'
  360IN."SORCERER "$Q
  370IF?Q=CH"Y";G.60
  380G.999
  390P.'"OH DEAR YOU APPEAR TO BE DEAD"'
  400P."WOULD YOU LIKE TO BE"'
  410IN."REINCARNATED "$Q
  420IF?Q=CH"N";G.999
  430IN."THE SAME SORCERER "$Q
  440IF?Q=CH"Y";G.160
  450G.60
  999P.$12;END
 1000M=M-R;IF M<1;R.
 1010P."YOU HAVE USED "R" UNITS."'
 1020P."YOU HAVE "M" UNITS LEFT."''
 1030R.
 2000G.(2000+10*AAZ)
 ...
 2110P."MAGIC SPOT"'';R.
 3000IN.'"WHICH CHAMBER DO YOU WISH TO"'"MOVE TO "P
 3010F=0;P.'
 3020F.I=0TO3
 3030IF BBI=P;F=1
 3040N.
 3050IF P=0 OR F=0;GOS.6000;G.3000
 3060IF C<>P;G.3180
 3070W=1;F=0
 3080F.I=0TO3
 3090T=A?(C*4-4+I)-48
 3100IF T=0 OR T=Y OR AAT=10 OR T=L;G.3130
 3110IF W=1 OR R.<0 C=T
 3120W=0;IF AAT=11;F=1
 3130N.
 3140IF W=1;R.
 3150IF F=0;P."THE SORCERER HAS RUN OFF !"'';G.3180 
 3160P."THE SORCERER TROD ON THE MAGIC"'
 3170P."SPOT !"'';X=0;GOS.7000;C=R;G.3060
 3180Y=P;IF AAP=0;R.
 3190IF AAP<>11;G.3230
 3200P."POWWW! YOU HAVE JUST TRODDEN ON"'
 3210P."THE MAGIC SPOT !"''
 3220X=0;GOS.7000;Y=R;R.
 3230IF AAP<>10;G.3300
 3240R=A.R.%20+20
 3250P."THE GNOME WILL TELL YOU WHERE THE"'
 3260P."SORCERER IS FOR "R" GOLD"'
 3270IN."COINS. AGREED "$Q 
 3280IF?Q<>CH"Y";R. 
