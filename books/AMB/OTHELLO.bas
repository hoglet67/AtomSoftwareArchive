...
1 P.$12;REM CLEAR SCREEN
2 P."        *** OTHELLO ***"'',"THIS GAME IS PLAYED BETWEEN "
3 P."THE COMPUTER (C) AND ITS HUMAN OPPONENT (H) ON A 8 X 8 "
4 P."BOARD. AT THE START OF THE GAME, EACH PLAYER HAS 2 "
5 P."PIECES IN THE CENTRE OF THE BOARD."',"H AND C TAKE TURNS"
6 P." TO PLACE A NEW PIECE IN ONE OF THE VACANT SQUARES SO AS"
7 P." TO 'CAPTURE' ONE OR MORE OPPONENTS PIECES."''
8 P."PRESS KEY TO CONTINUE ";LINK #FFE3
9 P.$12,"PIECES ARE CAPTURED IF THEY LIE ON A HORIZONTAL, "
10 P."VERTICAL OR DIAGONAL LINE TERMINATED AT ONE END BY THE "
11 P."PIECE JUST PLACED, AND AT THE OTHER END BY AN EXISTING "
12 P."PIECE BELONGING TO THE PLAYER MAKING THE MOVE. PIECES "
13 P."CAPTURED CHANGE TYPE TO THAT OF THE PLAYER CAPTURING "
14 P."THEM. EACH MOVE MUST CAPTURE AT LEAST ONE PIECE, OR ELSE"
15 P." THE PLAYER FORFEITS THAT MOVE. THE GAME ENDS WHEN ALL "
16 P."64 SQUARES HAVE BEEN FILLED, OR WHEN NEITHER PLAYER CAN "
17 P."MOVE."'',"PRESS KEY TO CONTINUE ";LINK #FFE3
18 P.$12,"THE PROGRAM DISPLAYS THE CURRENT SCORES AND THE "
19 P."STATE OF THE BOARD AFTER EACH MOVE. THE HUMAN PLAYER "
20 P."SHOULD ENTER HIS MOVE AS THE ROW (1-8) AND COLUMN (A-H)"
21 P." OF THE SELECTED SQUARE (E.G. 8A), OR HE MAY FORFEIT "
22 P."HIS MOVE BY JUST PRESSING THE 'RETURN' KEY. THE PROGRAM "
23 P."WILL NOT ACCEPT INVALID MOVES."''
24 P."PRESS KEY TO START ";LINK #FFE3
