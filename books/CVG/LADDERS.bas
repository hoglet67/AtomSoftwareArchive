...
320CLEAR0;@=0;P.''"PLAYER "R" IS THE WINNER !"'';GOS.s
322P."PRESS SPACE TO PLAY AGAIN"'"OR ESC TO STOP."'';LINK#FFE3
325RUN
326E.
...
570PLOT3,-1,-5
580R.
590yIN."HOW MANY(1-6) "M;IF M>6 OR M<1;P.$11;G.y
600DIM BB(M)
610P.'"IF YOU LAND ON AN OPPONENT"'"HE WILL BE SENT BACK TO"
620P." THE"'"START."''"YOU GET ANOTHER 'THROW' IF YOU"'"GET "
630P."A SIX."''"PRESS THE 'SPACE-BAR' TO THROW"'"THE DICE."
640P.''"PRESS 'RETURN' TO START";LI.#FFE3;R.
