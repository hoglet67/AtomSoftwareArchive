...
1130 RTS
1140\GET SCREEN ADDRESS IN #98
1150:LL0 LDX#325 GET D
1160:LL10 LDA@#20;STA#99
1170 LDA@95
1180 SEC
...
1300 LDA@0
1310:LL2 ROLA;ASLA NOW HAVE OFFSET FROM #98 FOR SHAPE
1320 TAX
1330 LDA #90,X
1340 STA #9A
1350 LDA #91,X
...
1400:LL3 LDA(#9A),Y GET PATTERN
1410 EOR(#98,X) INVERT SCREEN
1420 STA(#98,X)
1430 LDA #98;SEC
