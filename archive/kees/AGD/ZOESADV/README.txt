...
Tape version:
  ...
  ZOESADV.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  ZOESADV.DSK, Diskfile for emulators, to start the game, type *RUN"ZOERUN"

AtoMMC version:

  ZOERUN  = Basic introscreen
  ZOESCR  = Titlescreen
  ZOECODE = Gamecode

  To start the game, type: *ZOERUN
