...
Tape version:
  ...
  MYSTERIOUS2.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  MYSTERIOUS2.DSK, Diskfile for emulators, to start the game, type *RUN"M2RUN"

AtoMMC version:

  M2RUN  = Basic introscreen
  M2PAN  = Panelscreen
  M2SCR  = Titlescreen
  M2CODE = Gamecode

  To start the game, type: *M2RUN
