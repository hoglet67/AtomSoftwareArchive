...
Tape version:
  ...
  LINSPACE.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  LINSPACE.DSK, Diskfile for emulators, to start the game, type *RUN"LINRUN"

AtoMMC version:

  LINRUN  = Basic introscreen
  LINSCR  = Titlescreen
  LINCODE = Gamecode

  To start the game, type: *LINRUN
