...
Tape version:
  ...
  DKJR2.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  DKJR2.DSK, Diskfile for emulators, to start the game, type *RUN"JR2RUN"

AtoMMC version:

  JR2RUN  = Basic introscreen
  JR2SCR  = Titlescreen
  JR2CODE = Gamecode

  To start the game, type: *JR2RUN
