...
Tape version:
  ...
  TRIKTROL.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  TRIKTROL.DSK, Diskfile for emulators, to start the game, type *RUN"TRIRUN"

AtoMMC version:

  TRIRUN  = Basic introscreen
  TRISCR  = Titlescreen
  TRICODE = Gamecode

  To start the game, type: *TRIRUN
