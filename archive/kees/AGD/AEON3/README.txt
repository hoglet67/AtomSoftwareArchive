...
Tape version:
  ...
  AEON3.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  AEON3.DSK, Diskfile for emulators, to start the game, type *RUN"A3RUN"

AtoMMC version:

  A3RUN  = Basic introscreen
  A3SCR  = Titlescreen
  A3CODE = Gamecode

  To start the game, type: *A3RUN
