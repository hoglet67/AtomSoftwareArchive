...
Tape version:
  ...
  TL-BEAR.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  TL-BEAR.DSK, Diskfile for emulators, to start the game, type *RUN"TLBRUN"

AtoMMC version:

  TLBRUN  = Basic introscreen
  TLBSCR  = Titlescreen
  TLBCODE = Gamecode

  To start the game, type: *TLBRUN
