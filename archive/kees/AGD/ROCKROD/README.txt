...
Tape version:
  ...
  ROCKRODI.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  ROCKRODI.DSK, Diskfile for emulators, to start the game, type *RUN"RRRUN"

AtoMMC version:

  RRRUN  = Basic introscreen
  RRSCR  = Titlescreen
  RRCODE = Gamecode

  To start the game, type: *RRRUN
