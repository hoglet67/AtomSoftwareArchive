...
Tape version:
  ...
  DOOMPIT2.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  DOOMPIT2.DSK, Diskfile for emulators, to start the game, type *RUN"DP2RUN"

AtoMMC version:

  DP2RUN  = Basic introscreen
  DP2SCR  = Titlescreen
  DP2PAN   = Panelscreen
  DP2CODE = Gamecode

  To start the game, type: *DP2RUN
