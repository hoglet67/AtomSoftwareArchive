Monty's Last Strike - A Christmas Job:
--------------------------------------

Same game with a seasonal feel.
...
Welcome to Monty's Last Strike! At Christmas
...
Tape version:
  ...
  MONTYXMAS.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  MONTYXMAS.DSK, Diskfile for emulators, to start the game, type *RUN"MMXRUN"

AtoMMC version:

  MMXRUN  = Basic introscreen
  MMXSCR  = Titlescreen
  MMXCODE = Gamecode

  To start the game, type: *MMXRUN
