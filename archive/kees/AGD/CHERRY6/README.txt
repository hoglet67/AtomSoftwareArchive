...
Tape version:
  ...
  CHERRY68.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  CHERRY68.DSK, Diskfile for emulators, to start the game, type *RUN"C68RUN"

AtoMMC version:

  C68RUN  = Basic introscreen
  C68SCR  = Titlescreen
  C68CODE = Gamecode

  To start the game, type: *C68RUN
