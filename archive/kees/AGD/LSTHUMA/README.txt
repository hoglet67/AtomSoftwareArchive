...
Tape version:
  ...
  LSTHUMAN.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  LSTHUMAN.DSK, Diskfile for emulators, to start the game, type *RUN"LSTRUN"

AtoMMC version:

  LSTRUN  = Basic introscreen
  LSTSCR  = Titlescreen
  LSTCODE = Gamecode

  To start the game, type: *LSTRUN
