...
Tape version:
  ...
  AEON2.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  AEON2.DSK, Diskfile for emulators, to start the game, type *RUN"A2RUN"

AtoMMC version:

  A2RUN  = Basic introscreen
  A2SCR  = Titlescreen
  A2CODE = Gamecode

  To start the game, type: *A2RUN
