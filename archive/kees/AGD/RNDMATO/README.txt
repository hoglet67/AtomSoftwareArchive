...
Tape version:
  ...
  RNDMATOR.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  RNDMATOR.DSK, Diskfile for emulators, to start the game, type *RUN"RNDRUN"

AtoMMC version:

  RNDRUN  = Basic introscreen
  RNDSCR  = Titlescreen
  RNDCODE = Gamecode

  To start the game, type: *RNDRUN
