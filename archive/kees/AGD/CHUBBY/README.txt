...
Tape version:
  ...
  CHUBBY.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  CHUBBY.DSK, Diskfile for emulators, to start the game, type *RUN"CBRUN"

AtoMMC version:

  CBRUN  = Basic introscreen
  CBSCR  = Titlescreen
  CBCODE = Gamecode

  To start the game, type: *CBRUN
