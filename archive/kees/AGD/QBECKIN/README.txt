...
Tape version:
  ...
  QBECKING.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  QBECKING.DSK, Diskfile for emulators, to start the game, type *RUN"QBKRUN"

AtoMMC version:

  QBKRUN  = Basic introscreen
  QBKSCR  = Titlescreen
  QBKCODE = Gamecode

  To start the game, type: *QBKRUN
