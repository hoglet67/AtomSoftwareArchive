...
Tape version:
  ...
  BILQUEST.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  BILQUEST.DSK, Diskfile for emulators, to start the game, type *RUN"BILRUN"

AtoMMC version:

  BILRUN  = Basic introscreen
  BILSCR  = Titlescreen
  BILCODE = Gamecode

  To start the game, type: *BILRUN
