...
Tape version:
  ...
  CATTIVIK1C.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  CATTIVIK1C.DSK, Diskfile for emulators, to start the game, type *RUN"C1CRUN"

AtoMMC version:

  C1CRUN  = Basic introscreen
  C1CSCR  = Titlescreen
  C1CCODE = Gamecode

  To start the game, type: *C1CRUN
