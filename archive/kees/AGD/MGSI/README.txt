...
Tape version:
  ...
  MGSI.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  MGSI.DSK, Diskfile for emulators, to start the game, type *RUN"MGSRUN"

AtoMMC version:

  MGSRUN  = Basic introscreen
  MGSSCR  = Titlescreen
  MGSCODE = Gamecode

  To start the game, type: *MGSRUN
