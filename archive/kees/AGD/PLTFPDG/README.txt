...
Tape version:
  ...
  PLTFPDGY.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  PLTFPDGY.DSK, Diskfile for emulators, to start the game, type *RUN"PLTRUN"

AtoMMC version:

  PLTRUN  = Basic introscreen
  PLTSCR  = Titlescreen
  PLTCODE = Gamecode

  To start the game, type: *PLTRUN
