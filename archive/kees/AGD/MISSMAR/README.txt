...
Tape version:
  ...
  MISSMARS.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  MISSMARS.DSK, Diskfile for emulators, to start the game, type *RUN"MARRUN"

AtoMMC version:

  MARRUN  = Basic introscreen
  MARSCR  = Titlescreen
  MARCODE = Gamecode

  To start the game, type: *MARRUN
