...
Tape version:
  ...
  BOBBLOB.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  BOBBLOB.DSK, Diskfile for emulators, to start the game, type *RUN"BOBRUN"

AtoMMC version:

  BOBRUN  = Basic introscreen
  BOBSCR  = Titlescreen
  BOBCODE = Gamecode

  To start the game, type: *BOBRUN
