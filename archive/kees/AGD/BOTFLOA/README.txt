...
Tape version:
  ...
  BOTFLOAT.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  BOTFLOAT.DSK, Diskfile for emulators, to start the game, type *RUN"BOTRUN"

AtoMMC version:

  BOTRUN  = Basic introscreen
  BOTSCR  = Titlescreen
  BOTCODE = Gamecode

  To start the game, type: *BOTRUN
