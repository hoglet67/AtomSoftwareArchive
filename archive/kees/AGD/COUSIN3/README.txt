...
Tape version:
 ...
 COUSINH3.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  COUSINH3.DSK, Diskfile for emulators, to start the game, type *RUN"CH3RUN"

AtoMMC version:

  CH3RUN  = Basic introscreen
  CH3SCR  = Titlescreen
  CH3CODE = Gamecode

  To start the game, type: *CH3RUN
