...
Tape version:
  ...
  TIMTRAVL.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  TIMTRAVL.DSK, Diskfile for emulators, to start the game, type *RUN"TIMRUN"

AtoMMC version:

  TIMRUN  = Basic introscreen
  TIMSCR  = Titlescreen
  TIMCODE = Gamecode

  To start the game, type: *TIMRUN
