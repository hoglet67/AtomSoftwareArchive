...
Tape version:
  ...
  RUDXMAS.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  RUDXMAS.DSK, Diskfile for emulators, to start the game, type *RUN"RUDRUN"

AtoMMC version:

  RUDRUN  = Basic introscreen
  RUDSCR  = Titlescreen
  RUDCODE = Gamecode

  To start the game, type: *RUDRUN
