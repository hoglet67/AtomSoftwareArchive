...
Tape version:
  ...
  CATTIVIK1A.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  CATTIVIK1A.DSK, Diskfile for emulators, to start the game, type *RUN"C1ARUN"

AtoMMC version:

  C1ARUN  = Basic introscreen
  C1ASCR  = Titlescreen
  C1ACODE = Gamecode

  To start the game, type: *C1ARUN
