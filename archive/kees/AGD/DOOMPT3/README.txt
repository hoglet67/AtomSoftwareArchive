...
Tape version:
  ...
  DOOMPIT3.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  DOOMPIT3.DSK, Diskfile for emulators, to start the game, type *RUN"DP3RUN"

AtoMMC version:

  DP3RUN  = Basic introscreen
  DP3SCR  = Titlescreen
  DP3PAN   = Panelscreen
  DP3CODE = Gamecode

  To start the game, type: *DP3RUN
