...
Tape version:
  ...
  JOEYJUMP.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  JOEYJUMP.DSK, Diskfile for emulators, to start the game, type *RUN"JOERUN"

AtoMMC version:

  JOERUN  = Basic introscreen
  JOESCR  = Titlescreen
  JOECODE = Gamecode

  To start the game, type: *JOERUN
