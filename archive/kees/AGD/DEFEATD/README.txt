...
Tape version:
  ...
  DEVIL.CSW, Tapefile for Atomulator, to start the game, type: *RUN"AGD"

Disk version:

  DEVIL.DSK, Diskfile for emulators, to start the game, type *RUN"DDRUN"
