...
360 REM CTRL-KEY
370 IF?#B001&64>0 G.480
380 IF Y<>L-1 G.410
390 IF P=M G.300
400 P=P+1;GOS.i;Y=0;G.200
410 IF ?(#8060+Y*32)=32 G.480
415 GOS.i;Y=Y+1;GOS.i;G.300
470 REM KEY HANDLING
480 LINK #3303
490 IF ?#80=0 G.300
495 IF ?#80=21 F=0;GOS.z;G.200
496 IF ?#80=28 P=P-1+(P=1)*M;GOS.i;Y=0;G.200
497 IF ?#80=30 P=P+1-(P=M)*M;GOS.i;Y=0;G.200
500 IF ?#80>21 AND ?#80<25 F=?#80-21;GOS.x;G.200
510 IF ?#80<17 OR ?#80>20 G.580
520 IF F>0 F=0;GOS.z
530 S=?#80-17;GOS.y;G.200
