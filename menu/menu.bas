...
800 F=?#80-20;Z=!(#8202+F*2)&#FFFF;?#8B=255;?#8C=0
810 G.900
820yP.$30
...
920zP.$30'"                                "$30
930 V=J+4
940 IF F=1 P.'"  PUBLISHER="$V';?#8C=2
950 IF F=2 P.'"  GENRE="$V';?#8C=1
960 IF F=3 P.'"  COLLECTION="$V';?#8C=3
970 F=0;?#80=17;?#8D=I;GOS.y;M=!J&#FFFF;M=(M+L-1)/L;RET.
