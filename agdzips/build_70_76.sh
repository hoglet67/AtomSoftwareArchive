...
touch HERBIE/_Herbie_wants_to_be_a_Millionaire.txt
...
DIRS=$(find [0-9A-Z]* -maxdepth 1 -type d  | sort)
...
do
    ...
    cd ..
    echo -e "$id,V14B1,AGD,AGD,C.Kees' AGD Ports,$title,Game,Kees van Oss,AGD/$i,8200,CH.\"$run\",Test,\"$files\",present,AGD,Yes"
